    ...
    if(Input::exists()){
        if(Token::check(Input::get('token'))) {
            ...
            if($validation->passed()){
                ...
                if($notification){
                    echo "Your notification successfully added.</br>";
...
<form action="" method="post" class="form-horizontal">
    <div>
        <strong>Topic</strong>
        <input class="form-control" id="topic" type="text" name="topic" autocomplete="off" value="<?php echo escape(Input::get('topic')); ?>" >
    </div>
    <div>
    ...
    <?php echo "<br/><a href=notif_main_forum.php>View all notification</a>";?>
